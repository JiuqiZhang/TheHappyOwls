...
export default FeedbackScreen = ({ navigation }) => {
  ...
  return (
    ...
    <Text style={styles.title}>Share your feedback</Text>
      ...
      <Text>
        We'd love to hear your thoughts! Whether it's a feature you adore or
        something you think could be improved, your feedback helps us create an
        app that you'll truly love.
        {"\n\n"}
      </Text>
